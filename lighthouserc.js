...
const urls = ['/', '/unicorp-ms51575-6/p/', '/unicorp-ms51575-6/p/', '/door-and-access-hardware/'].map((path) => `${server}${path}`)
    ...
    assert: {
      ...
      assertions: {
        ...
        'uses-rel-preconnect': [
          'warn',
          {
            maxNumericValue: 2 // somehow lighthouse ci can't find the dns-prefetch tags we are adding
          }
        ],
        'categories:pwa': 'off',
        'categories:seo': [
